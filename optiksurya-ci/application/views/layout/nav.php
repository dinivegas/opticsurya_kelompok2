<?php
//ambi data menu dari konfigurasi
...
<?php 
		...
		<div class="header-cart-buttons size11 tras-0-4 m-t-10 m-b-10">
		...
		<div class="wrap_header_mobile">
			...
			<a href="index.html" class="logo-mobile">
				<img src="<?php echo base_url() ?>assets/template/image/icons/logo.png" alt="IMG-LOGO">
			</a>
...
<div class="btn-show-menu">
	...
	<div class="header-icons-mobile">
		<a href="#" class="header-wrapicon1 dis-block">
			<img src="<?php echo base_url() ?>assets/template/image/icons/icon-header-01.png" class="header-icon1" alt="ICON">
		</a>
		...
		?>
			<img src="<?php echo base_url() ?>assets/template/image/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="ICON">
...
<ul class="main-menu">
	...
	<!-- menu mobile produk -->
	<li class="item-menu-mobile">
		<a href="<?php echo base_url('produk') ?>">Home</a>
		<ul class="sub-menu">
