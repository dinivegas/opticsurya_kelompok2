...
<head>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/themify-icons.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/nice-select.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/flaticon.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/gijgo.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/animate.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/slicknav.css">
    <link rel="stylesheet" href="http://system/codeigniter-3/assets/css/style.css">
                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="<?php echo site_url('Startup/index');?>">
                                    <img src="http://system/codeigniter-3/assets/img/logo.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-8">
                            <div class="main-menu  d-none d-lg-block text-center">
                                <nav>
                                    <ul id="navigation">
                                        <li><a class="active" href="<?echo site_url('Startup/index');?>">home</a></li>
                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="http://system/codeigniter-3/assets/img/blog/single_blog_1.png" alt="">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="<?php echo site_url('Startup/single_blog');?>">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="http://system/codeigniter-3/assets/img/blog/single_blog_2.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="http://system/codeigniter-3/assets/img/blog/single_blog_3.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="http://system/codeigniter-3/assets/img/blog/single_blog_4.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="http://system/codeigniter-3/assets/img/blog/single_blog_5.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img src="http://system/codeigniter-3/assets/img/post/post_1.png" alt="post">
                                <div class="media-body">
                                    <a href="<?php echo site_url('Startup/single_blog');?>">
                            ...
                            <div class="media post_item">
                                <img src="http://system/codeigniter-3/assets/img/post/post_3.png" alt="post">
                                <div class="media-body">
                                    <a href="<?php echo site_url('Startup/single_blog');?>">
                            ...
                            <div class="media post_item">
                                <img src="http://system/codeigniter-3/assets/img/post/post_4.png" alt="post">
                                <div class="media-body">
                                    <a href="<?php echo site_url('Startup/single_blog');?>">
                        ...
                        <aside class="single_sidebar_widget instagram_feeds">
                            ...
                            <ul class="instagram_row flex-wrap">
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="http://system/codeigniter-3/assets/img/post/post_5.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="http://system/codeigniter-3/assets/img/post/post_6.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="http://system/codeigniter-3/assets/img/post/post_7.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="http://system/codeigniter-3/assets/img/post/post_8.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="http://system/codeigniter-3/assets/img/post/post_9.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="http://system/codeigniter-3/assets/img/post/post_10.png" alt="">
                                    </a>
                                </li>
                            </ul>
                        </aside>
