            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  <div class="feature-img">
                     <img class="img-fluid" src="http://localhost/codeigniter-3/assets/img/blog/single_blog_1.png" alt="">
                  </div>
                  ...
                  <div class="navigation-area">
                     <div class="row">
                        <div
                           ...
                           <div class="thumb">
                              <a href="#">
                                 <img class="img-fluid" src="http://localhost/codeigniter-3/assets/img/post/preview.png" alt="">
                              </a>
                           </div>
                           <div class="arrow">
                              <a href="#">
               ...
               <div class="blog-author">
                  <div class="media align-items-center">
                     <img src="http://localhost/codeigniter-3/assets/img/blog/author.png" alt="">
               ...
               <div class="comments-area">
                  ...
                  <div class="comment-list">
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                           <div class="thumb">
                              <img src="http://localhost/codeigniter-3/assets/img/comment/comment_1.png" alt="">
                           </div>
                           <div class="desc">
                              <p class="comment">
                  ...
                  <div class="comment-list">
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                           <div class="thumb">
                              <img src="http://localhost/codeigniter-3/assets/img/comment/comment_2.png" alt="">
                           </div>
                           <div class="desc">
                              <p class="comment">
                                 Multiply sea night grass fourth day sea lesser rule open subdue female fill which them
                  ...
                  <div class="comment-list">
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                           <div class="thumb">
                              <img src="http://localhost/codeigniter-3/assets/img/comment/comment_3.png" alt="">
                           </div>
                           <div class="desc">
                              <p class="comment">
                                 Multiply sea night grass fourth day sea lesser rule open subdue female fill which them
               ...
               <div class="blog_right_sidebar">
                  ...
                  <aside class="single_sidebar_widget popular_post_widget">
                     ...
                     <div class="media post_item">
                        <img src="http://localhost/codeigniter-3/assets/img/post/post_1.png" alt="post">
                        <div class="media-body">
                     ...
                     <div class="media post_item">
                        <img src="http://localhost/codeigniter-3/assets/img/post/post_2.png" alt="post">
                        <div class="media-body">
                           <a href="<?php echo site_url('Startup/single_blog');?>">
                     ...
                     <div class="media post_item">
                        <img src="http://localhost/codeigniter-3/assets/img/post/post_3.png" alt="post">
                        <div class="media-body">
                           <a href="<?php echo site_url('Startup/single_blog');?>">
                     ...
                     <div class="media post_item">
                        <img src="http://localhost/codeigniter-3/assets/img/post/post_4.png" alt="post">
                        <div class="media-body">
                           <a href="<?php echo site_url('Startup/single_blog');?>">
                  ...
                  <aside class="single_sidebar_widget instagram_feeds">
                     ...
                     <ul class="instagram_row flex-wrap">
                        <li>
                           <a href="#">
                              <img class="img-fluid" src="http://localhost/codeigniter-3/assets/img/post/post_5.png" alt="">
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img class="img-fluid" src="http://localhost/codeigniter-3/assets/img/post/post_6.png" alt="">
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img class="img-fluid" src="http://localhost/codeigniter-3/assets/img/post/post_7.png" alt="">
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img class="img-fluid" src="http://localhost/codeigniter-3/assets/img/post/post_8.png" alt="">
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img class="img-fluid" src="http://localhost/codeigniter-3/assets/img/post/post_9.png" alt="">
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img class="img-fluid" src="http://localhost/codeigniter-3/assets/img/post/post_10.png" alt="">
                           </a>
                        </li>
                     </ul>
                  </aside>
