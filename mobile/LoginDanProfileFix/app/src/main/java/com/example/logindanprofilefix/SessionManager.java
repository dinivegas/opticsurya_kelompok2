...
public class SessionManager {
        ...
        public void createSession(String nama_pelanggan, String telepon, String alamat, String id_pelanggan) {
        ...
        pelanggan.put(TELEPON, sharedPreferences.getString(TELEPON, null));
